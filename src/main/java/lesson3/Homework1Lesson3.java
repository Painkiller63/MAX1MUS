    ...
    public static void main(String[] args) {
        try {
            ...
            if (a == 0) {
                ...
                double d = Math.pow(b, 2) - (4 * a * c); // вычисляем дискриминант квадратного уравнения.
                //Определяем число корней уравнения, проверяя условие. Если корни есть, вычисляем их.
                if (d < 0) {
